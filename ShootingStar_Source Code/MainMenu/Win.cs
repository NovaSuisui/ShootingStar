...
namespace ShootingStar.MainMenu
{
    public class Win : _MainScreen
    {
        ...
        public Win(Main game, GraphicsDeviceManager graphicsDevice, ContentManager content) : base(game, graphicsDevice, content)
        {
            /*-------------------------------------TAR WORK SPACE -------------------------------------*/
            ...
            _lightsaber = (Texture2D)Singleton.Instance.instanceGreenLightSaber;
        ...
        public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(_lightsaber, new Vector2(0, 0), Color.White);
